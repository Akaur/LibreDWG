 ...
 */
unsigned int
checksum (unsigned int seed, unsigned char *p, unsigned int n)
{
  //seed = 0;
                        ...
                        unsigned long int decomp_data_size)
{
  ...
  dwg->header.section_info = (Dwg_Section_Info*) malloc(sizeof
                              (Dwg_Section_Info) * dwg->header.num_descriptions);
...
/* Encrypted Data Section Page Header */
...
decode_R2004(Bit_Chain* dat, Dwg_Data * dwg)
{
  ...
  union
  {
    ...
    struct
    {
      ...
      unsigned int last_section_page_id;
      unsigned long int last_section_page_end_address;
      unsigned long int second_header_address;
      unsigned int gap_amount;
      unsigned int section_page_amount;
      unsigned int x20;
      unsigned int x80;
      unsigned int x40;
      unsigned int section_page_map_id;
      unsigned long int section_page_map_address;
      unsigned int section_map_id;
      unsigned int section_page_array_size;
  ...
  typedef union _system_section
  {
    ...
    struct
    {
      ...
      unsigned int section_page_checksum;
    } fields;
  } system_section;
  ...
  if (loglevel)
    {
      ...
      LOG_TRACE("Last section page id: %x\n",
          (unsigned int) _2004_header_data.fields.last_section_page_id)
      LOG_TRACE("Last section page end address: %X\n",
          (unsigned long int) _2004_header_data.fields.last_section_page_end_address)
      LOG_TRACE("Second header data address: %X\n",
          (unsigned long int) _2004_header_data.fields.second_header_address)
      LOG_TRACE("Gap amount: %x\n",
          (unsigned int) _2004_header_data.fields.gap_amount)
      LOG_TRACE("Section amount: %x\n",
          (unsigned int) _2004_header_data.fields.section_page_amount)
      ...
      LOG_TRACE("Section page map id: %x\n",
          (unsigned int) _2004_header_data.fields.section_page_map_id)
      LOG_TRACE("Section page map address: %X\n",
          (unsigned long int) _2004_header_data.fields.section_page_map_address + 0x100)
      LOG_TRACE("Section map id: %x\n",
          (unsigned int) _2004_header_data.fields.section_map_id)
      LOG_TRACE("Section array size: %x\n",
          (unsigned int) _2004_header_data.fields.section_page_array_size)
      LOG_TRACE("Gap array size: %x\n",
          (unsigned int) _2004_header_data.fields.gap_array_size)
      LOG_TRACE("CRC: %x\n", (unsigned int) _2004_header_data.fields.CRC32)
    }
   ...
   * Section Map
   */
  dat->byte = _2004_header_data.fields.section_page_map_address + 0x100;
   // section page header
  ...
  LOG_TRACE("Section page checksum: %x\n\n", (unsigned int) ss.fields.section_page_checksum)

  
  read_R2004_section_map(dat, dwg,
      ss.fields.comp_data_size, ss.fields.decomp_data_size);
  checksum (0, ss.fields.decomp_data_size, ss.fields.comp_data_size);
   ...
   * Section Info
   */
  section = find_section(dwg, _2004_header_data.fields.section_map_id);
